...
static SPU_WB_FORCEINLINE u128 wb_to_u128(__m128i v)
{
    u128 r;
    _mm_storeu_si128((__m128i*)(void*)&r, v);
    return r;
}
static SPU_WB_FORCEINLINE __m128i wb_from_u128(u128 v)
{
...
static SPU_WB_FORCEINLINE uint32_t wb_pref(__m128i v) { return (uint32_t)_mm_cvtsi128_si32(v); }
/* Scalar -> preferred slot, other slots zero (spu_link / spu_pref_u32). */
static SPU_WB_FORCEINLINE __m128i wb_pref_set(uint32_t v) { return _mm_cvtsi32_si128((int)v); }
...
static SPU_WB_FORCEINLINE __m128i wb_ones(void)  { return _mm_set1_epi32(-1); }
static SPU_WB_FORCEINLINE __m128i wb_not(__m128i a) { return _mm_xor_si128(a, wb_ones()); }
/* unsigned per-lane compares via sign-bit flip */
static SPU_WB_FORCEINLINE __m128i wb_cmpgtu32(__m128i a, __m128i b)
{
    const __m128i f = _mm_set1_epi32((int)0x80000000u);
    return _mm_cmpgt_epi32(_mm_xor_si128(a, f), _mm_xor_si128(b, f));
}
static SPU_WB_FORCEINLINE __m128i wb_cmpgtu16(__m128i a, __m128i b)
{
    const __m128i f = _mm_set1_epi16((short)0x8000u);
    return _mm_cmpgt_epi16(_mm_xor_si128(a, f), _mm_xor_si128(b, f));
}
static SPU_WB_FORCEINLINE __m128i wb_cmpgtu8(__m128i a, __m128i b)
{
...
static SPU_WB_FORCEINLINE __m128i wb_lo16sx(__m128i a) { return _mm_srai_epi32(_mm_slli_epi32(a, 16), 16); }
static SPU_WB_FORCEINLINE __m128i wb_lo16zx(__m128i a) { return _mm_and_si128(a, _mm_set1_epi32(0xFFFF)); }
/* host byte index j -> SPU byte position (j ^ 3), as a vector iota */
static SPU_WB_FORCEINLINE __m128i wb_spuidx(void)
{
 ...
 * Integer arithmetic
 * =======================================================================*/
static SPU_WB_FORCEINLINE __m128i wbk_a(__m128i a, __m128i b)   { return _mm_add_epi32(a, b); }
static SPU_WB_FORCEINLINE __m128i wbk_sf(__m128i a, __m128i b)  { return _mm_sub_epi32(b, a); }
static SPU_WB_FORCEINLINE __m128i wbk_ah(__m128i a, __m128i b)  { return _mm_add_epi16(a, b); }
static SPU_WB_FORCEINLINE __m128i wbk_sfh(__m128i a, __m128i b) { return _mm_sub_epi16(b, a); }
static SPU_WB_FORCEINLINE __m128i wbk_ai(__m128i a, int32_t imm)  { return _mm_add_epi32(a, _mm_set1_epi32(imm)); }
static SPU_WB_FORCEINLINE __m128i wbk_ahi(__m128i a, int32_t imm) { return _mm_add_epi16(a, _mm_set1_epi16((short)imm)); }
static SPU_WB_FORCEINLINE __m128i wbk_sfi(__m128i a, int32_t imm) { return _mm_sub_epi32(_mm_set1_epi32(imm), a); }
static SPU_WB_FORCEINLINE __m128i wbk_sfhi(__m128i a, int32_t imm){ return _mm_sub_epi16(_mm_set1_epi16((short)imm), a); }
/* addx: a + b + (t & 1) per word */
static SPU_WB_FORCEINLINE __m128i wbk_addx(__m128i a, __m128i b, __m128i t)
{
    return _mm_add_epi32(_mm_add_epi32(a, b), _mm_and_si128(t, _mm_set1_epi32(1)));
}
/* sfx: b + ~a + (t & 1) per word */
static SPU_WB_FORCEINLINE __m128i wbk_sfx(__m128i a, __m128i b, __m128i t)
{
    return _mm_add_epi32(_mm_add_epi32(b, wb_not(a)), _mm_and_si128(t, _mm_set1_epi32(1)));
}
/* cg: carry-out of unsigned a + b */
static SPU_WB_FORCEINLINE __m128i wbk_cg(__m128i a, __m128i b)
{
...
static SPU_WB_FORCEINLINE __m128i wbk_cgx(__m128i a, __m128i b, __m128i t)
{
...
static SPU_WB_FORCEINLINE __m128i wbk_bg(__m128i a, __m128i b)
{
    return _mm_andnot_si128(wb_cmpgtu32(a, b), _mm_set1_epi32(1));
}
/* bgx: carry-out of b + ~a + (t & 1) */
static SPU_WB_FORCEINLINE __m128i wbk_bgx(__m128i a, __m128i b, __m128i t)
{
    const __m128i cin = _mm_and_si128(t, _mm_set1_epi32(1));
 ...
 * =======================================================================*/
static SPU_WB_FORCEINLINE __m128i wbk_mpy(__m128i a, __m128i b)   { return _mm_mullo_epi32(wb_lo16sx(a), wb_lo16sx(b)); }
static SPU_WB_FORCEINLINE __m128i wbk_mpyu(__m128i a, __m128i b)  { return _mm_mullo_epi32(wb_lo16zx(a), wb_lo16zx(b)); }
static SPU_WB_FORCEINLINE __m128i wbk_mpyi(__m128i a, int32_t imm) { return _mm_mullo_epi32(wb_lo16sx(a), _mm_set1_epi32((int32_t)(int16_t)imm)); }
static SPU_WB_FORCEINLINE __m128i wbk_mpyui(__m128i a, int32_t imm){ return _mm_mullo_epi32(wb_lo16zx(a), _mm_set1_epi32((uint16_t)imm)); }
static SPU_WB_FORCEINLINE __m128i wbk_mpyh(__m128i a, __m128i b)
{
    return _mm_slli_epi32(_mm_mullo_epi32(_mm_srai_epi32(a, 16), wb_lo16sx(b)), 16);
}
static SPU_WB_FORCEINLINE __m128i wbk_mpyhh(__m128i a, __m128i b)  { return _mm_mullo_epi32(_mm_srai_epi32(a, 16), _mm_srai_epi32(b, 16)); }
static SPU_WB_FORCEINLINE __m128i wbk_mpyhhu(__m128i a, __m128i b) { return _mm_mullo_epi32(_mm_srli_epi32(a, 16), _mm_srli_epi32(b, 16)); }
static SPU_WB_FORCEINLINE __m128i wbk_mpyhha(__m128i a, __m128i b, __m128i t)
{
    return _mm_add_epi32(t, wbk_mpyhh(a, b));
}
static SPU_WB_FORCEINLINE __m128i wbk_mpyhhau(__m128i a, __m128i b, __m128i t)
{
    return _mm_add_epi32(t, wbk_mpyhhu(a, b));
}
static SPU_WB_FORCEINLINE __m128i wbk_mpys(__m128i a, __m128i b)
{
    return _mm_srai_epi32(wbk_mpy(a, b), 16);
}
static SPU_WB_FORCEINLINE __m128i wbk_mpya(__m128i a, __m128i b, __m128i c)
{
 ...
 * Bitwise logic
 * =======================================================================*/
static SPU_WB_FORCEINLINE __m128i wbk_and(__m128i a, __m128i b)  { return _mm_and_si128(a, b); }
static SPU_WB_FORCEINLINE __m128i wbk_or(__m128i a, __m128i b)   { return _mm_or_si128(a, b); }
static SPU_WB_FORCEINLINE __m128i wbk_xor(__m128i a, __m128i b)  { return _mm_xor_si128(a, b); }
static SPU_WB_FORCEINLINE __m128i wbk_nand(__m128i a, __m128i b) { return wb_not(_mm_and_si128(a, b)); }
static SPU_WB_FORCEINLINE __m128i wbk_nor(__m128i a, __m128i b)  { return wb_not(_mm_or_si128(a, b)); }
static SPU_WB_FORCEINLINE __m128i wbk_andc(__m128i a, __m128i b) { return _mm_andnot_si128(b, a); }
static SPU_WB_FORCEINLINE __m128i wbk_orc(__m128i a, __m128i b)  { return _mm_or_si128(a, wb_not(b)); }
static SPU_WB_FORCEINLINE __m128i wbk_eqv(__m128i a, __m128i b)  { return wb_not(_mm_xor_si128(a, b)); }
static SPU_WB_FORCEINLINE __m128i wbk_andi(__m128i a, int32_t imm) { return _mm_and_si128(a, _mm_set1_epi32(imm)); }
static SPU_WB_FORCEINLINE __m128i wbk_ori(__m128i a, int32_t imm)  { return _mm_or_si128(a, _mm_set1_epi32(imm)); }
static SPU_WB_FORCEINLINE __m128i wbk_xori(__m128i a, int32_t imm) { return _mm_xor_si128(a, _mm_set1_epi32(imm)); }
static SPU_WB_FORCEINLINE __m128i wbk_andhi(__m128i a, int32_t imm){ return _mm_and_si128(a, _mm_set1_epi16((short)imm)); }
static SPU_WB_FORCEINLINE __m128i wbk_orhi(__m128i a, int32_t imm) { return _mm_or_si128(a, _mm_set1_epi16((short)imm)); }
static SPU_WB_FORCEINLINE __m128i wbk_xorhi(__m128i a, int32_t imm){ return _mm_xor_si128(a, _mm_set1_epi16((short)imm)); }
static SPU_WB_FORCEINLINE __m128i wbk_andbi(__m128i a, int32_t imm){ return _mm_and_si128(a, _mm_set1_epi8((char)imm)); }
static SPU_WB_FORCEINLINE __m128i wbk_orbi(__m128i a, int32_t imm) { return _mm_or_si128(a, _mm_set1_epi8((char)imm)); }
static SPU_WB_FORCEINLINE __m128i wbk_xorbi(__m128i a, int32_t imm){ return _mm_xor_si128(a, _mm_set1_epi8((char)imm)); }
static SPU_WB_FORCEINLINE __m128i wbk_iohl(__m128i a, int32_t imm) { return _mm_or_si128(a, _mm_set1_epi32((uint16_t)imm)); }

/* =========================================================================
 * Compares (all-ones / all-zeros per lane)
 * =======================================================================*/
static SPU_WB_FORCEINLINE __m128i wbk_ceq(__m128i a, __m128i b)   { return _mm_cmpeq_epi32(a, b); }
static SPU_WB_FORCEINLINE __m128i wbk_ceqh(__m128i a, __m128i b)  { return _mm_cmpeq_epi16(a, b); }
static SPU_WB_FORCEINLINE __m128i wbk_ceqb(__m128i a, __m128i b)  { return _mm_cmpeq_epi8(a, b); }
static SPU_WB_FORCEINLINE __m128i wbk_cgt(__m128i a, __m128i b)   { return _mm_cmpgt_epi32(a, b); }
static SPU_WB_FORCEINLINE __m128i wbk_cgth(__m128i a, __m128i b)  { return _mm_cmpgt_epi16(a, b); }
static SPU_WB_FORCEINLINE __m128i wbk_cgtb(__m128i a, __m128i b)  { return _mm_cmpgt_epi8(a, b); }
static SPU_WB_FORCEINLINE __m128i wbk_clgt(__m128i a, __m128i b)  { return wb_cmpgtu32(a, b); }
static SPU_WB_FORCEINLINE __m128i wbk_clgth(__m128i a, __m128i b) { return wb_cmpgtu16(a, b); }
static SPU_WB_FORCEINLINE __m128i wbk_clgtb(__m128i a, __m128i b) { return wb_cmpgtu8(a, b); }
static SPU_WB_FORCEINLINE __m128i wbk_ceqi(__m128i a, int32_t imm)  { return _mm_cmpeq_epi32(a, _mm_set1_epi32(imm)); }
static SPU_WB_FORCEINLINE __m128i wbk_cgti(__m128i a, int32_t imm)  { return _mm_cmpgt_epi32(a, _mm_set1_epi32(imm)); }
static SPU_WB_FORCEINLINE __m128i wbk_clgti(__m128i a, int32_t imm) { return wb_cmpgtu32(a, _mm_set1_epi32(imm)); }
static SPU_WB_FORCEINLINE __m128i wbk_ceqhi(__m128i a, int32_t imm) { return _mm_cmpeq_epi16(a, _mm_set1_epi16((short)imm)); }
static SPU_WB_FORCEINLINE __m128i wbk_cgthi(__m128i a, int32_t imm) { return _mm_cmpgt_epi16(a, _mm_set1_epi16((short)imm)); }
static SPU_WB_FORCEINLINE __m128i wbk_clgthi(__m128i a, int32_t imm){ return wb_cmpgtu16(a, _mm_set1_epi16((short)imm)); }
static SPU_WB_FORCEINLINE __m128i wbk_ceqbi(__m128i a, int32_t imm) { return _mm_cmpeq_epi8(a, _mm_set1_epi8((char)imm)); }
static SPU_WB_FORCEINLINE __m128i wbk_cgtbi(__m128i a, int32_t imm) { return _mm_cmpgt_epi8(a, _mm_set1_epi8((char)imm)); }
static SPU_WB_FORCEINLINE __m128i wbk_clgtbi(__m128i a, int32_t imm){ return wb_cmpgtu8(a, _mm_set1_epi8((char)imm)); }

/* =========================================================================
 * Select / shuffle
 * =======================================================================*/
static SPU_WB_FORCEINLINE __m128i wbk_selb(__m128i a, __m128i b, __m128i c)
{
...
static SPU_WB_FORCEINLINE __m128i wbk_shufb(__m128i va, __m128i vb, __m128i vc)
{
 ...
 * =======================================================================*/
static SPU_WB_FORCEINLINE __m128i wbk_shli(__m128i a, int sh)
{
    sh &= 0x3F;
    return (sh > 31) ? _mm_setzero_si128() : _mm_slli_epi32(a, sh);
}
static SPU_WB_FORCEINLINE __m128i wbk_shlhi(__m128i a, int sh)
{
    sh &= 0x1F;
    return (sh > 15) ? _mm_setzero_si128() : _mm_slli_epi16(a, sh);
}
static SPU_WB_FORCEINLINE __m128i wbk_roti(__m128i a, int sh)
{
    sh &= 31;
    return sh ? _mm_or_si128(_mm_slli_epi32(a, sh), _mm_srli_epi32(a, 32 - sh)) : a;
}
static SPU_WB_FORCEINLINE __m128i wbk_rothi(__m128i a, int sh)
{
    sh &= 15;
    return sh ? _mm_or_si128(_mm_slli_epi16(a, sh), _mm_srli_epi16(a, 16 - sh)) : a;
}
static SPU_WB_FORCEINLINE __m128i wbk_rotmi(__m128i a, int i7)
{
    const int sh = (0 - i7) & 0x3F;
    return (sh > 31) ? _mm_setzero_si128() : _mm_srli_epi32(a, sh);
}
static SPU_WB_FORCEINLINE __m128i wbk_rotmai(__m128i a, int i7)
{
    const int sh = (0 - i7) & 0x3F;
    return _mm_srai_epi32(a, sh > 31 ? 31 : sh);
}
static SPU_WB_FORCEINLINE __m128i wbk_rotmhi(__m128i a, int i7)   /* a.k.a. rothmi text form */
{
    const int sh = (0 - i7) & 0x1F;
    return (sh > 15) ? _mm_setzero_si128() : _mm_srli_epi16(a, sh);
}
static SPU_WB_FORCEINLINE __m128i wbk_rothmi(__m128i a, int i7) { return wbk_rotmhi(a, i7); }
static SPU_WB_FORCEINLINE __m128i wbk_rotmahi(__m128i a, int i7)
{
    const int sh = (0 - i7) & 0x1F;
    return _mm_srai_epi16(a, sh > 15 ? 15 : sh);
}
/* per-lane variable word shifts (AVX2) */
static SPU_WB_FORCEINLINE __m128i wbk_shl(__m128i a, __m128i b)
{
    return _mm_sllv_epi32(a, _mm_and_si128(b, _mm_set1_epi32(0x3F)));
}
static SPU_WB_FORCEINLINE __m128i wbk_rotm(__m128i a, __m128i b)
{
    const __m128i sh = _mm_and_si128(_mm_sub_epi32(_mm_setzero_si128(), b),
                                     _mm_set1_epi32(0x3F));
    return _mm_srlv_epi32(a, sh);
}
static SPU_WB_FORCEINLINE __m128i wbk_rotma(__m128i a, __m128i b)
{
    const __m128i sh = _mm_and_si128(_mm_sub_epi32(_mm_setzero_si128(), b),
                                     _mm_set1_epi32(0x3F));
    return _mm_srav_epi32(a, sh);
}
static SPU_WB_FORCEINLINE __m128i wbk_rot(__m128i a, __m128i b)
{
 ...
 * =======================================================================*/
static SPU_WB_FORCEINLINE __m128i wbk_shlqbii(__m128i a, int sh)
{
    sh &= 7;
    if (!sh) return a;
...
static SPU_WB_FORCEINLINE __m128i wbk_rotqbii(__m128i a, int sh)
{
    sh &= 7;
    if (!sh) return a;
...
static SPU_WB_FORCEINLINE __m128i wbk_rotqmbii(__m128i a, int i7)
{
    const int sh = (0 - i7) & 7;
    if (!sh) return a;
...
static SPU_WB_FORCEINLINE __m128i wbk_shlqbi(__m128i a, __m128i b)  { return wbk_shlqbii(a, (int)(wb_pref(b) & 7)); }
static SPU_WB_FORCEINLINE __m128i wbk_rotqbi(__m128i a, __m128i b)  { return wbk_rotqbii(a, (int)(wb_pref(b) & 7)); }
static SPU_WB_FORCEINLINE __m128i wbk_rotqmbi(__m128i a, __m128i b)
{
...
static SPU_WB_FORCEINLINE __m128i wb_byteshift_left_sel(int sh)   /* result SPU byte i := SPU byte i+sh, else 0 */
{
...
static SPU_WB_FORCEINLINE __m128i wb_byterot_sel(int sh)          /* result SPU byte i := SPU byte (i+sh) & 15 */
{
    const __m128i spuidx = wb_spuidx();
...
static SPU_WB_FORCEINLINE __m128i wb_byteshift_right_sel(int sh)  /* result SPU byte i := SPU byte i-sh, else 0 */
{
    const __m128i spuidx = wb_spuidx();
...
static SPU_WB_FORCEINLINE __m128i wbk_shlqbyi(__m128i a, int sh)
{
    sh &= 0x1F;
    if (sh >= 16) return _mm_setzero_si128();
    return _mm_shuffle_epi8(a, wb_byteshift_left_sel(sh));
}
static SPU_WB_FORCEINLINE __m128i wbk_rotqbyi(__m128i a, int sh)
{
    return _mm_shuffle_epi8(a, wb_byterot_sel(sh & 0x0F));
}
static SPU_WB_FORCEINLINE __m128i wbk_rotqmbyi(__m128i a, int i7)
{
    const int sh = (0 - i7) & 0x1F;
    if (sh >= 16) return _mm_setzero_si128();
    return _mm_shuffle_epi8(a, wb_byteshift_right_sel(sh));
}
static SPU_WB_FORCEINLINE __m128i wbk_shlqby(__m128i a, __m128i b)   { return wbk_shlqbyi(a, (int)(wb_pref(b) & 0x1F)); }
static SPU_WB_FORCEINLINE __m128i wbk_rotqby(__m128i a, __m128i b)   { return wbk_rotqbyi(a, (int)(wb_pref(b) & 0x0F)); }
static SPU_WB_FORCEINLINE __m128i wbk_shlqbybi(__m128i a, __m128i b) { return wbk_shlqbyi(a, (int)((wb_pref(b) >> 3) & 0x1F)); }
static SPU_WB_FORCEINLINE __m128i wbk_rotqbybi(__m128i a, __m128i b) { return wbk_rotqbyi(a, (int)((wb_pref(b) >> 3) & 0x0F)); }
static SPU_WB_FORCEINLINE __m128i wbk_rotqmby(__m128i a, __m128i b)
{
    const int sh = (0 - (int)wb_pref(b)) & 0x1F;
    if (sh >= 16) return _mm_setzero_si128();
    return _mm_shuffle_epi8(a, wb_byteshift_right_sel(sh));
}
static SPU_WB_FORCEINLINE __m128i wbk_rotqmbybi(__m128i a, __m128i b)
{
 ...
 * =======================================================================*/
static SPU_WB_FORCEINLINE __m128i wbk_xsbh(__m128i a) { return _mm_srai_epi16(_mm_slli_epi16(a, 8), 8); }
static SPU_WB_FORCEINLINE __m128i wbk_xshw(__m128i a) { return _mm_srai_epi32(_mm_slli_epi32(a, 16), 16); }
static SPU_WB_FORCEINLINE __m128i wbk_xswd(__m128i a)
{
    const __m128i odd = _mm_shuffle_epi32(a, _MM_SHUFFLE(3, 3, 1, 1));
    return _mm_blend_epi16(_mm_srai_epi32(odd, 31), odd, 0xCC);
}
static SPU_WB_FORCEINLINE __m128i wbk_orx(__m128i a)
{
...
static SPU_WB_FORCEINLINE __m128i wbk_cntb(__m128i a)
{
...
static SPU_WB_FORCEINLINE __m128i wbk_absdb(__m128i a, __m128i b)
{
    return _mm_or_si128(_mm_subs_epu8(a, b), _mm_subs_epu8(b, a));
}
static SPU_WB_FORCEINLINE __m128i wbk_avgb(__m128i a, __m128i b) { return _mm_avg_epu8(a, b); }
static SPU_WB_FORCEINLINE __m128i wbk_sumb(__m128i a, __m128i b)
{
...
static SPU_WB_FORCEINLINE __m128i wbk_gb(__m128i a)
{
...
static SPU_WB_FORCEINLINE __m128i wbk_fsm(__m128i a)
{
...
static SPU_WB_FORCEINLINE __m128i wbk_fsmh(__m128i a)
{
...
static SPU_WB_FORCEINLINE __m128i wbk_fsmb(__m128i a)
{
 ...
 * =======================================================================*/
static SPU_WB_FORCEINLINE __m128i wb_gen_base(void)
{
...
static SPU_WB_FORCEINLINE __m128i wbk_cbd_pos(uint32_t pos)
{
    const __m128i spuidx = wb_spuidx();
...
static SPU_WB_FORCEINLINE __m128i wbk_chd_pos(uint32_t pos)
{
    const __m128i spuidx = wb_spuidx();
...
static SPU_WB_FORCEINLINE __m128i wbk_cwd_pos(uint32_t pos)
{
    const __m128i spuidx = wb_spuidx();
    const __m128i mask = _mm_cmpeq_epi8(
...
static SPU_WB_FORCEINLINE __m128i wbk_cdd_pos(uint32_t pos)
{
    const __m128i spuidx = wb_spuidx();
    const __m128i mask = _mm_cmpeq_epi8(
