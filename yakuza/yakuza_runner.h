...
/* Copies a live context while the registry lock still pins the owning
 * thread's stack-local ppu_context. Returns 0 if the thread already exited. */
extern "C" int      yz_thread_context_snapshot(uint32_t tid,
                                                ppu_context* out);
