...
> All credit for the original SDK, runtime, and HLE library work goes to [sp00nznet](https://github.com/sp00nznet). This repo carries my fixes specifici to the Yakuza-specific port; the general, game-agnostic fixes get sent back upstream through the branches on the [ps3recomp-yakuzadeadsouls](https://github.com/canersaka/ps3recomp-yakuzadeadsouls) repo.
...
The next big step is hooking up the GPU backend and opening a real window. Full rendering is the long road after that.
