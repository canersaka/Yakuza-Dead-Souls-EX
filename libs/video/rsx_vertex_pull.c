                                 ...
                                 char* out, u32 out_size)
{
    ...
    pull_emit(&o,
        ...
        "    if (yz_source == 1u)\n"
        "        return yz_load_be16(yz_pull_misc1.y & 1u,\n"
        "                            yz_pull_misc1.x +\n"
        "                            (slot - (yz_pull_misc1.y >> 1)) * 2u);\n"
        "    if (yz_source == 2u)\n"
        "        return yz_load_be32(yz_pull_misc1.y & 1u,\n"
        "                            yz_pull_misc1.x +\n"
        "                            (slot - (yz_pull_misc1.y >> 1)) * 4u);\n"
        "    return slot;\n"
        "}\n");
    ...
    for (u32 attr = 0; attr < RSX_DSP_NUM_VERTEX_ATTR; attr++) {
        ...
        pull_emitf(&o,
            ...
            "    uint addr = yz_base_offset + cfg.x +\n"
            "                (elem - (cfg.w >> 2)) * cfg.y;\n"
